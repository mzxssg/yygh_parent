...
import com.mzxssg.yygh.user.utils.ConstantWxPropertiesUtils;
import com.mzxssg.yygh.user.utils.HttpClientUtils;
...
public class WeixinApiController {
     ...
     * 获取微信登录参数
     */
    @ApiOperation(value = "生成微信扫描二维码,获取微信登录参数")
