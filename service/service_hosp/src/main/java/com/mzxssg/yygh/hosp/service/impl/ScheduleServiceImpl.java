...
import com.mzxssg.yygh.model.hosp.BookingRule;
...
import com.mzxssg.yygh.vo.hosp.BookingScheduleRuleVo;
...
//停号时间
    ...
    private IPage getListDate(int page, int limit, BookingRule bookingRule) {
        ...
        //TODO 这里releaseTime.isBeforeNow()应该错了，后面进行研究测试，应该是DateTime stopTime = this.getDateTime(new Date(), bookingRule.getStopTime())这个后面再加上isBeforeNow()方法
